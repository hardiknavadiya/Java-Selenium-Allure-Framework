package org.navadiya.tests.mobile;

import io.qameta.allure.Description;
import io.qameta.allure.Step;
import org.navadiya.pages.LoginPage;
import org.navadiya.tests.BaseTest;
import org.navadiya.util.ScreenshotUtils;
import org.navadiya.util.mobile.LocationPermissionHandler;
...
public class amazonSignIn extends BaseTest {
    ...
    public void loginWithPageObjectModel() {
        ...
        // Handle location permission - "Allow while visiting the site" / "Allow While Using App"
        LocationPermissionHandler.allowWhileUsing(getDriver());
